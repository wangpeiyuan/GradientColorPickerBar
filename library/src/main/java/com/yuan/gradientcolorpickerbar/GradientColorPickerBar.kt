package com.yuan.gradientcolorpickerbar
...
class GradientColorPickerBar : View {
    ...
    private fun init(context: Context, attrs: AttributeSet?) {
        ...
        thumbSize = a.getDimension(R.styleable.GradientColorPickerBar_thumbSize, thumbSize)
        thumbCorner = a.getDimension(R.styleable.GradientColorPickerBar_thumbRadius, thumbCorner)
        thumbStrokeColor =
            a.getColor(R.styleable.GradientColorPickerBar_thumbStrokeColor, thumbStrokeColor)
        thumbStrokeWidth =
            a.getDimension(R.styleable.GradientColorPickerBar_thumbStrokeWidth, thumbStrokeWidth)
        barHeight = a.getDimension(R.styleable.GradientColorPickerBar_barHeight, barHeight)
        barCorner = a.getDimension(R.styleable.GradientColorPickerBar_barRadius, barCorner)
        orientation = a.getInt(R.styleable.GradientColorPickerBar_orientation, HORIZONTAL)
        val resIdForColors = a.getResourceId(R.styleable.GradientColorPickerBar_colorEntries, -1)
        if (resIdForColors != -1) {
            colors = resources.getIntArray(resIdForColors)
        }
        progress = a.getFloat(R.styleable.GradientColorPickerBar_progress, progress)
        a.recycle()
    }
